  ...
  return (
    <div className="w-full">
      ...
      <select
        id={selectId}
        className={[
          'h-9 w-full appearance-none rounded-[7px] border border-[#cbd5e1] bg-white bg-[length:1rem] bg-[position:right_0.5rem_center] bg-no-repeat py-0 pl-2.5 pr-8 text-sm leading-9 text-ink',
